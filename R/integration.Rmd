...
geomx$status <- factor(
  ifelse(
    geomx$genotype %in% c("MAPTKI", "P301S"), yes = "Non_Contacting",
    no = ifelse(
      geomx$genotype %in% c("NLGF_MAPTKI", "NLGF_P301S"), yes = "Contacting",
      no = "Other"
    )
  )
)
...
snrnaseq$genotype_status <- factor(
  ...
  levels = c(
    "MAPTKI_Contacting", "MAPTKI_Non_Contacting",
    "P301S_Contacting", "P301S_Non_Contacting",
    "NLGF_MAPTKI_Contacting", "NLGF_MAPTKI_Non_Contacting",
    "NLGF_P301S_Contacting", "NLGF_P301S_Non_Contacting"
  )
)
