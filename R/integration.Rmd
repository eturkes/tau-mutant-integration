...
snrnaseq$genotype_status <- factor(
  ...
  levels = c(
    "MAPTKI_Activated", "MAPTKI_Non_Contacting",
    "P301S_Activated", "P301S_Non_Contacting",
    "NLGF_MAPTKI_Activated", "NLGF_MAPTKI_Non_Contacting",
    "NLGF_P301S_Activated", "NLGF_P301S_Non_Contacting"
  )
)
