...
if (file.exists(rds)) {
  ...
  seurat$genotype_status_cleaned <- factor(
    ...
    levels = c(
      "MAPTKI",
      "P301S",
      "NLGF_MAPTKI_Homeostatic",
      "NLGF_MAPTKI_Activated",
      "NLGF_P301S_Homeostatic",
      "NLGF_P301S_Activated"
    )
  )
...
cont_mat <- makeContrasts(
  ...
  NLGF_MAPTKI_HOMEOSTATIC_MAPTKI =
    gse.genotype_status_cleanedNLGF_MAPTKI_Homeostatic -
    gse.genotype_status_cleanedMAPTKI,
  NLGF_MAPTKI_ACTIVATED_MAPTKI =
    gse.genotype_status_cleanedNLGF_MAPTKI_Activated -
    gse.genotype_status_cleanedMAPTKI,
  NLGF_MAPTKI_ACTIVATED_NLGF_MAPTKI_HOMEOSTATIC =
    gse.genotype_status_cleanedNLGF_MAPTKI_Activated -
    gse.genotype_status_cleanedNLGF_MAPTKI_Homeostatic,
  NLGF_P301S_HOMEOSTATIC_P301S =
    gse.genotype_status_cleanedNLGF_P301S_Homeostatic -
    gse.genotype_status_cleanedP301S,
  NLGF_P301S_ACTIVATED_P301S =
    gse.genotype_status_cleanedNLGF_P301S_Activated -
    gse.genotype_status_cleanedP301S,
  NLGF_P301S_ACTIVATED_NLGF_P301S_HOMEOSTATIC =
    gse.genotype_status_cleanedNLGF_P301S_Activated -
    gse.genotype_status_cleanedNLGF_P301S_Homeostatic,
  NLGF_P301S_HOMEOSTATIC_NLGF_MAPTKI_HOMEOSTATIC =
    gse.genotype_status_cleanedNLGF_P301S_Homeostatic -
    gse.genotype_status_cleanedNLGF_MAPTKI_Homeostatic,
  NLGF_P301S_ACTIVATED_NLGF_MAPTKI_ACTIVATED =
    gse.genotype_status_cleanedNLGF_P301S_Activated -
    gse.genotype_status_cleanedNLGF_MAPTKI_Activated,
  levels = design
)
...
results_gse <- results_gse[ , 2:ncol(results_gse)]
...
cont_mat <- makeContrasts(
  ...
  NLGF_MAPTKI_HOMEOSTATIC_MAPTKI =
    deg.genotype_status_cleanedNLGF_MAPTKI_Homeostatic -
    deg.genotype_status_cleanedMAPTKI,
  NLGF_MAPTKI_ACTIVATED_MAPTKI =
    deg.genotype_status_cleanedNLGF_MAPTKI_Activated -
    deg.genotype_status_cleanedMAPTKI,
  NLGF_MAPTKI_ACTIVATED_NLGF_MAPTKI_HOMEOSTATIC =
    deg.genotype_status_cleanedNLGF_MAPTKI_Activated -
    deg.genotype_status_cleanedNLGF_MAPTKI_Homeostatic,
  NLGF_P301S_HOMEOSTATIC_P301S =
    deg.genotype_status_cleanedNLGF_P301S_Homeostatic -
    deg.genotype_status_cleanedP301S,
  NLGF_P301S_ACTIVATED_P301S =
    deg.genotype_status_cleanedNLGF_P301S_Activated -
    deg.genotype_status_cleanedP301S,
  NLGF_P301S_ACTIVATED_NLGF_P301S_HOMEOSTATIC =
    deg.genotype_status_cleanedNLGF_P301S_Activated -
    deg.genotype_status_cleanedNLGF_P301S_Homeostatic,
...
results_deg <- results_deg[ , 2:ncol(results_deg)]
