...
cont_mat <- makeContrasts(
  ...
  NLGF_MAPTKI_vs_NC_MAPTKI =
    gse.genotype_status_cleanedNLGF_MAPTKI_NC -
    gse.genotype_status_cleanedMAPTKI,
  NLGF_MAPTKI_C_vs_NLGF_MAPTKI_NC =
    gse.genotype_status_cleanedNLGF_MAPTKI_C -
    gse.genotype_status_cleanedNLGF_MAPTKI_NC,
  NLGF_P301S_C_vs_NLGF_MAPTKI_C =
    (gse.genotype_status_cleanedNLGF_P301S_C -
     gse.genotype_status_cleanedNLGF_P301S_NC) -
    (gse.genotype_status_cleanedNLGF_MAPTKI_C -
     gse.genotype_status_cleanedNLGF_MAPTKI_NC),
  NLGF_P301S_NC_vs_NLGF_MAPTKI_NC =
    (gse.genotype_status_cleanedNLGF_P301S_NC -
     gse.genotype_status_cleanedP301S) -
    (gse.genotype_status_cleanedNLGF_MAPTKI_NC -
     gse.genotype_status_cleanedMAPTKI),
...
keep <- filterByExpr(
  dge_orig, group = deg$genotype_status_cleaned,
  min.count = 10, min.total.count = 15
)
dge_orig <- dge_orig[keep, ]
dge_orig <- calcNormFactors(dge_orig)
...
dge$samples$norm.factors <- dge_orig$samples$norm.factors
keep <- filterByExpr(
  dge, group = deg$genotype_status_cleaned,
...
cont_mat <- makeContrasts(
  ...
  NLGF_MAPTKI_vs_NC_MAPTKI =
    deg.genotype_status_cleanedNLGF_MAPTKI_NC -
    deg.genotype_status_cleanedMAPTKI,
  NLGF_MAPTKI_C_vs_NLGF_MAPTKI_NC =
    deg.genotype_status_cleanedNLGF_MAPTKI_C -
    deg.genotype_status_cleanedNLGF_MAPTKI_NC,
  NLGF_P301S_C_vs_NLGF_MAPTKI_C =
    (deg.genotype_status_cleanedNLGF_P301S_C -
     deg.genotype_status_cleanedNLGF_P301S_NC) -
    (deg.genotype_status_cleanedNLGF_MAPTKI_C -
     deg.genotype_status_cleanedNLGF_MAPTKI_NC),
  NLGF_P301S_NC_vs_NLGF_MAPTKI_NC =
    (deg.genotype_status_cleanedNLGF_P301S_NC -
